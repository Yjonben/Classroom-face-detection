...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5x_PartA.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/Part_A.yaml', help='data.yaml path')
